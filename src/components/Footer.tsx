      ...
      <div className="mx-auto max-w-6xl px-6 pt-14 pb-10">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5 mb-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2 font-bold text-lg text-primary mb-4">
              <span
                aria-hidden="true"
          ...
          <div className="flex items-center gap-3 order-1 sm:order-2">
            {SOCIAL_LINKS.map((s) => (
              <a
                ...
                href={s.href}
                aria-label={s.label}
                className="flex h-8 w-8 items-center justify-center rounded-lg text-muted transition-all duration-150 hover:text-primary hover:bg-white/5"
              >
                {s.icon}
              </a>
            ))}
